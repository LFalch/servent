fn extension_to_mime(extension: Option<&str>) -> &'static str {
    ...
    match extension {
        ...
        Some("addin") => "text/xml; charset=utf8",
        ...
        Some("disco") => "text/xml; charset=utf8",
        Some("dll") => "application/x-msdownload",
        Some("dll.config") => "text/xml; charset=utf8",
        ...
        Some("dtd") => "text/xml; charset=utf8",
        Some("dtsConfig") => "text/xml; charset=utf8",
        Some("dv") => "video/x-dv",
        ...
        Some("eot") => "application/octet-stream",
        ...
        Some("exe.config") => "text/xml; charset=utf8",
        ...
        Some("mno") => "text/xml; charset=utf8",
        ...
        Some("ssisdeploymentmanifest") => "text/xml; charset=utf8",
        ...
        Some("ttf") => "application/octet-stream",
        ...
        Some("vml") => "text/xml; charset=utf8",
        Some("vscontent") => "application/xml",
        Some("vsct") => "text/xml; charset=utf8",
        Some("vsd") => "application/vnd.visio",
        Some("vsi") => "application/ms-vsi",
        Some("vsix") => "application/vsix",
        Some("vsixlangpack") => "text/xml; charset=utf8",
        Some("vsixmanifest") => "text/xml; charset=utf8",
        ...
        Some("vssettings") => "text/xml; charset=utf8",
        Some("vssscc") => "text/plain; charset=utf8",
        Some("vst") => "application/vnd.visio",
        Some("vstemplate") => "text/xml; charset=utf8",
        ...
        Some("wsdl") => "text/xml; charset=utf8",
        ...
        Some("xml") => "text/xml; charset=utf8",
        ...
        Some("xrm-ms") => "text/xml; charset=utf8",
        Some("xsc") => "application/xml",
        Some("xsd") => "text/xml; charset=utf8",
        Some("xsf") => "text/xml; charset=utf8",
        Some("xsl") => "text/xml; charset=utf8",
        Some("xslt") => "text/xml; charset=utf8",
